...
const { categoryPage, createCategory, getAllCategories, getOneCategory, updateOneCategory, deleteOneCategory, getCategoryMeals, updateCategoryPage } = require('../controller/categoryController')
