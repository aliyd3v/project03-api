...
const { adminCreate, deleteOneAdmin, adminsPage, profilePage, updateOneAdmin, adminCreatePage, updateAdminPage, updatePasswordAdmin, updatePasswordAdminPage } = require('../controller/adminContoller')
